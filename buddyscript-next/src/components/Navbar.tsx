                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                        <li className="nav-item _header_nav_item">
                            <a
                                className="_header_nav_link_active _header_nav_link"
                                href="/feeds"
                                aria-current="page"
                            >
                                <svg
                        ...
                        <li className="nav-item _header_nav_item">
                            <a className="_header_nav_link" href="/friend-request">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="26"
                                    height="20"
                        ...
                        <li className="nav-item _header_nav_item">
                            <span
                                ...
                                onKeyDown={(event) => handleKeyToggle(event, toggleNotifyDropdown)}
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="20"
                                            ...
                                            <div className="_notifications_drop_right">
                                                <ul className="_notification_list">
                                                    <li className="_notification_item">
                                                        <span className="_notification_link">Mark all as read</span>
                                                    </li>
                                                    <li className="_notification_item">
                                                ...
                                                <div key={notification.id} className="_notification_box">
                                                    ...
                                                    <div className="_notification_txt">
                                                        <p className="_notification_para">
                                                            <span className="_notify_txt_link">{notification.name}</span>{" "}
                                                            {notification.detail}
                                                        </p>
                        ...
                        <li className="nav-item _header_nav_item">
                            <a className="_header_nav_link" href="/chat">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="23"
                                    height="22"
                        ...
                        >
                            ...
                            <ul className="_nav_dropdown_list">
                                <li className="_nav_dropdown_list_item">
                                    <a href="/settings" className="_nav_dropdown_link">
                                ...
                                <li className="_nav_dropdown_list_item">
                                    <a href="/support" className="_nav_dropdown_link">
                                        <div className="_nav_drop_info">
                                            <span>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="_nav_dropdown_list_item">
                                    <a href="/logout" className="_nav_dropdown_link">
                                        <div className="_nav_drop_info">
                                            <span>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
